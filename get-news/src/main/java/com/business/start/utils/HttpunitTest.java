...
//            HttpunitTest.testFormSubmit();
    ...
    public static void testGetHtmlContent() throws IOException, SAXException {
        ...
        // 向指定的URL发出请求，获取响应
        WebResponse wr = wc.getResponse("http://m.zhangxinzhixun.com/?q=56bad9a0&r=r1&key=15687086582562406&channel=yule&articleFrom=spider&sign=45fbebc355e2d5ec7927344e577b8148");
        // 用getText方法获取相应的全部内容
    ...
    public static void testFormSubmit(){
        HttpUnitOptions.setScriptingEnabled(false);
        WebConversation wc = new WebConversation();
        WebRequest request = new PostMethodWebRequest("http://m.zhangxinzhixun.com/?q=56bad9a0&r=r1&key=15687086582562406&channel=yule&articleFrom=spider&sign=45fbebc355e2d5ec7927344e577b8148");
